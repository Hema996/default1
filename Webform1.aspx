<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Webform1.aspx.cs" Inherits="AOSmyproject.WebForm1" %>
...
<div class="main-menu js-expanded-menu ">
        ...
        <a href="#" tabindex="-1">About</a>
               ...
               <li class="menu-item">
        <a href="#" tabindex="-1">Academics</a>
              </li>
			  <li class="menu-item">
        <a href="Admissions.php" tabindex="-1">Admissions</a>
              </li>
			  <li class="menu-item">
        <a href="#" tabindex="-1">Accreditations</a>
              </li>
                <li class="menu-item">
        <a href="#" tabindex="-1">Student Life</a>
                           </li>
   
                <li class="menu-item">
        <a href="#" tabindex="-1" >IELTS Preps </a>
              </li>
                <li class="menu-item">
        <a href="#" tabindex="-1">Learn English</a>
              </li>
        </ul>
...
<div id="block-dynamicfooterfirstblock" class="block block-spcs-domain block-dynamic-footer-first-block">
  ...
  <div class="logo-footer branding">
    <a class="logo" href="#">
      <img src="images/Logo.png" alt="Footer logo" width="160" height="34">
    </a>
  </div>
...
<a href="mailto:ohsadmissions@stanford.edu">aosadmissions@aos.org</a></p></div>
  ...
  <div class="support-us">
    ...
    <a class="btn small" href="giving.html" style="color:white">Make a Gift</a>
  </div>
