<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ielts.aspx.cs" Inherits="AOSmyproject.Ielts" %>
...
<script>
    ...
    $(function () {
        $("#saveielts").click(function () {
            $("#saveielts").attr("disabled", "disabled");
            var name = $("#name").val();
            ...
            if (name != "" && email != "" && surname != "" && city != "" && dob != "" && gender != "" && zip != "") {
	...
	<script type="text/javascript">
	    $(document).ready(function () {
	        $('input[type="checkbox"]').click(function () {
	            if ($('#gecheck').prop("checked") == true && $('#aecheck').prop("checked") == true) {
	                ...
	                $("#tprice").text("55.00 USD");
	                twomoney()
	            }

	            if ($('#gecheck').prop("checked") == true && $('#aecheck').prop("checked") == false) {
	                ...
	                $("#tprice").text("27.50 USD");
	                onmoney()
	            }

	            if ($('#gecheck').prop("checked") == false && $('#aecheck').prop("checked") == false) {
	                ...
	                $("#tprice").text("00.00 USD");

	            }

	            if ($('#gecheck').prop("checked") == false && $('#aecheck').prop("checked") == true) {
	            ...
	            function twomoney() {
	                $('#money').on('change', function () {
	                    ...
	                    if (money == "eur") {
	                        $("#tprice").text("51.4 EUR");
	                    }
	                    if (money == "usd") {
	                        $("#tprice").text("55.00 USD");
	                    }
	                    if (money == "dinar") {
	                        $("#tprice").text("16.74 Dinar");
	                    }
	                });
	            }
	            ...
	            function onmoney() {
	                $('#money').on('change', function () {
	                    var money = this.value;
	                    if (money == "eur") {
	                        $("#tprice").text("25.7 EUR");
	                    }
	                    if (money == "usd") {
	                        $("#tprice").text("27.50 USD");
	                    }
	                    if (money == "dinar") {
	                        $("#tprice").text("8.37 Dinar");
	                    }
	                });
	            }
	        });
                            ...
                            <div class="header-main__right">
                                ...
                                <div class="navigation-menu">
                                    <div class="region region-main-menu">
                                        <div id="block-dynamicmainmenublock" class="block block-dynamic-main-menu-block">
...
<div class="block-media media-left bg--white text--dark ">
  <div class="container">
          <h1 class="block-media__big-title text--center">IELTS preparation material</h1>
        <div class="block-media__group">
            ...
            <div class="field field--name-field-image field--type-image field--label-hidden field__item">  <img src="images/ielts.jpg" width="460" height="340" typeof="foaf:Image" class="image-style-_60x540" />
                    ...
                    <div class="block-media__content bg--white text--dark">
                      <%--<h3 class="page-heading__title" style="text-align:center">Key features</h3>--%>
                                <%--<div class="page-heading__description">  <ul class="list" style="padding-right: 0px;">--%>
						<%--<li class="wow fadeIn">Over 85 hours of effective, interactive study materials</li>
						<li class="wow fadeIn">With or without tutor support (tutors are experienced IELTS teachers)</li>
						<li class="wow fadeIn">Learn techniques to improve your band score</li>
						<li class="wow fadeIn">Tablet compatible (iPad and Android)</li>
						<li class="wow fadeIn">A wide range of additional tools and features</li>
						<li class="wow fadeIn">Helpful and useful services</li>
						<li class="wow fadeIn">Effective methodology</li>--%>
                            <ul class="red-tick" style="padding-right:0px">
							<li><i class="fa fa-check"></i>Introduction to the different components of the academic or general training versions of the IELTS exam</li>
							<li><i class="fa fa-check"></i>Contains 30 hours of study material</li>
							<li><i class="fa fa-check"></i>Exam technique</li>
							<li><i class="fa fa-check"></i>Preparation for the Listening test</li>
							<li><i class="fa fa-check"></i>Preparation for the Reading test</li>
							<li><i class="fa fa-check"></i>Preparation for the Speaking test</li>
							<li><i class="fa fa-check"></i>Preparation for the Writing test</li>
							<li><i class="fa fa-check"></i>Access to a complete IELTS practice test</li>
							<li><i class="fa fa-check"></i>Band score for the 4 tests and overall band score for the exam</li>
						</ul>
        ...
        <h3>Taking the IELTS exam? Improve your band score for IELTS speaking, IELTS writing, IELTS listening and IELTS reading tests.</h3>
      </div>
							...
							<tr data-ng-repeat="product in enIelts.versionSelected.premium" ng-if="enIelts.searchCourse($index)" class="ng-scope">
								...
								<td>
									<div class="ng-scope" data-ng-if="enIelts.versionSelected.essential[$index] != null">
										<div>
                                            <asp:RadioButton ID="RadioButton1" runat="server" Text="27.50 USD" OnCheckedChanged="RadioButton1_CheckedChanged"></asp:RadioButton>
                            ...
                            <td class="ng-binding">IELTS Preparation Course and Practice Test 1 (Academic)</td>
								<td>
									<!-- ngIf: enIelts.versionSelected.essential[$index] != null --><div class="ng-scope" data-ng-if="enIelts.versionSelected.essential[$index] != null">
										<div>
										<asp:RadioButton ID="RadioButton2" runat="server" Text="27.50 USD" />
										</div>
                ...
                <div class="col-md-6">
                  ...
                  <th>
                      ...
                      <tbody>
                          <tr>
                              <td>
                                  IELTS Preparation Course and Practice Test (General Training) - Essential       27.50 USD
                              </td>
                          </tr>
                          <tr>
                              <td>
                 ...
                 <table class="course-table" >
                     <tbody>
                         <tr>
                             <td>
                                 US Dollars<br />
                                 <asp:RadioButton ID="RadioButton3" runat="server" Text="Credit Card" value="1"/>
                             </td>
                         </tr>
                         <tr>
                             <td>
                                 Euros<br />
                                 <asp:RadioButton ID="RadioButton4" runat="server" Text="Credit Card"  value="2"/>
                             </td>
                         </tr>
                         <tr>
                             <td>
                                 Kuwaiti dinar <br />
                                 <asp:RadioButton ID="RadioButton5" runat="server" Text="Credit Card" value="3" />
                             </td>
                         </tr>
                     </tbody>
                 </table>
